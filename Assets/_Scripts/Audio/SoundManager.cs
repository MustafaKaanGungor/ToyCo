...
public class SoundManager : MonoBehaviour
{
    ...
    private void OnPlaySound(SfxType soundType)
    {
        ...
        if (_clips[i] == null)
        {
            Debug.LogWarning($"Eksik ses referansi: {soundType}");
            return;
        }
    ...
    private void OnPlayMusic(MusicType musicType)
    {
        ...
        {
            Debug.LogWarning($"Eksik muzik referansi: {musicType}");
            return;
        }
...
public enum MusicType { MainMenu, Gameplay, Boss, Victory, Slot, COUNT }